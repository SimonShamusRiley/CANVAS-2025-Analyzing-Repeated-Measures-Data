...
Proc HPMIXED data=Selected lognote;
	...
	Model response= System|Trt|Year|DAP|Depth/;*ddf= 36 36 288 288 288 288 720 720 720 720 720 720 720 720 720;
	Random  Block  Trt*Block  Trt*Year*Block;
	Random Year/ subject = Trt*Block Type=UN;
	...
	ods output tests3=AOV covparms=Cout fitstatistics=Fout lsmeans=agr.lsmeans diffs=agr.diffs;
run;
ods select all;
...
/*libname xl xlsx "Model_complete_repeated_Year_DAP_Depth.xlsx";*/
